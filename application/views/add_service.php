...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6"> <br />
      ...
      <hr />
      <form  name="addproduct" action="<?php echo base_url('dataservice/'.$method.'/'.$con->id_service)?>" method="post" enctype="multipart/form-data"  class="form-horizontal">
        ...
        <div class="form-group">
          <div class="col-sm-12">
            ...
            <textarea name="time" id="time"  class="form-control"  rows="3"  required placeholder="ระยะเวลาการทำ" value="<?php echo $con->time ?>"></textarea>
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-3">
