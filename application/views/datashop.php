...
<body class="w3-white">
    ...
    <nav class="w3-sidebar w3-collapse w3-light-blue w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="datacustomer" class="w3-bar-item w3-button w3-padding "><i class="fa fa-users fa-fw"></i>&nbsp; ข้อมูลลูกค้า</a>
            <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>&nbsp; ข้อมูลช่างทำผม</a>
                ...
                <?php foreach ($read as $value) { ?>
                    <tbody>
                        <tr>
                            ...
                            <td><button class="btn btn-info" type="button"  data-href="<?php echo $value->id_customer ?>" id="edit" data-toggle="modal" ">แก้ไข</button>
                            <td><button type="button"  data-href="<?php echo $value->id_customer ?>" id="delete" data-toggle="modal" ">ลบ</button>
                            </td>
                        </tr>
                    </tbody>
                <?php } ?>
