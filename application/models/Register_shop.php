...
class Register_shop extends CI_Model{
    ...
    public function read_member($name_shop,$name_shopowner,$email_shopowner,$phone_shopowner,$pass,$t_open,$t_close)
    {
        $where = array(
            'name_shop' => $name_shop,
        ...
        $this->db->select('name_shop,name_shopowner,email_shopowner,phone_shopowner,pass')->from('register_shop')->where($where);
        $qurey = $this->db->get();
        return $qurey->result();
    }
